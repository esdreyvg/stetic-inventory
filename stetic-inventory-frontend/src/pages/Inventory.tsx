...
const Inventory: React.FC = () => {
  ...
  const canManageInventory = useMemo(() => hasRole(['administrador', 'gerente']), [hasRole]);
  ...
  }, [inventoryItems, filters, activeTab]);
  ...
  const handleFilterChange = useCallback((key: keyof InventoryFilters, value: string | boolean) => {
  ...
  useEffect(() => {
    applyFilters();
  }, [applyFilters]); // Now applyFilters is memoized with useCallback
